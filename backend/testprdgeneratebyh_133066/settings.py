"""
Django settings for testprdgeneratebyh_133066 project.
...
ROOT_URLCONF = 'testprdgeneratebyh_133066.urls'
...
WSGI_APPLICATION = 'testprdgeneratebyh_133066.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testprdgeneratebyh_133066 API",
    "DESCRIPTION": "API documentation for testprdgeneratebyh_133066 App",
    "VERSION": "v1",
}
